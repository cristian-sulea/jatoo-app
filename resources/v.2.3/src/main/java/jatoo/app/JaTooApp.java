...
public interface JaTooApp {
	...
	void setTrayIconActionListener(ActionListener trayIconActionListener);

	ActionListener getTrayIconActionListener();
	 ...
	 *          the message to display
	 */
	void showTrayMessage(String caption, String message);
	 ...
	 *          the message to display
	 */
	void showTrayErrorMessage(String caption, String message);
	 ...
	 *          the message to display
	 */
	void showTrayWarningMessage(String caption, String message);
	 ...
	 *          the message to display
	 */
	void showTrayInformationMessage(String caption, String message);
